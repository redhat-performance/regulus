...
export TPL_PAO=1
export TPL_DPF=1
export TPL_EXTRA_RESOURCES=./resource-dpf.json

envsubst '$MCP,$TPL_DPF,$TPL_PAO,$TPL_SCALE_UP_FACTOR,$TPL_TOPO,$TPL_EXTRA_RESOURCES' < ${REG_TEMPLATES}/run.sh.template > ${MANIFEST_DIR}/run.sh
