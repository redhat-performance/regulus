#!/bin/bash
# iperf UDP,internode, 16 4-CPU Pods. bitrate: 8 pods transmit each direction, step up bitrate
...
export TPL_IPV=4
envsubst '$TPL_INTF,$TPL_IPV' <  ${REG_TEMPLATES}/udp-bitrate-mv-params.json.template >  ${MANIFEST_DIR}/mv-params.json
