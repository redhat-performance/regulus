...
export TPL_PAO=1
export TPL_DPF=1
export TPL_QOS_MODE=static

envsubst '$TPL_QOS_MODE,$MCP,$TPL_DPF,$TPL_PAO,$TPL_SCALE_UP_FACTOR,$TPL_TOPO' < ${REG_TEMPLATES}/run.sh.template > ${MANIFEST_DIR}/run.sh
...
cp ${REG_COMMON}/annotations-dpf.json.template  ${MANIFEST_DIR}//annotations-dpf.json
