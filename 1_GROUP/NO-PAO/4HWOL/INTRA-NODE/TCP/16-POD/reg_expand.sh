#!/bin/bash
# uperf NO-PAO,HWOL,IPv4,INTRA_NODE,2 Pods
...
envsubst '$TPL_EXTRA_RESOURCES,$TPL_HWOL,$TPL_SCALE_UP_FACTOR,$TPL_TOPO' < ${REG_TEMPLATES}/run.sh.template > ${MANIFEST_DIR}/run.sh
