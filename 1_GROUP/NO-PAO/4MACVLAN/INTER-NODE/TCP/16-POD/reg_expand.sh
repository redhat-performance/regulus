#!/bin/bash
# uperf PAO,MACVLAN,IPv4,TCP,INTER-NODE, 18 Pods
...
export TPL_PAO=0
envsubst '$MCP,$TPL_PAO,$TPL_SRIOV,$TPL_MACVLAN,$TPL_SCALE_UP_FACTOR,$TPL_TOPO' < ${REG_TEMPLATES}/run.sh.template > ${MANIFEST_DIR}/run.sh
