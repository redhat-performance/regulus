#!/usr/bin/env python3
"""
    Script to detect datapath model from annotation files.
    Searches all *annotation* files in current directory.

    Usage: DEBUG=1 reg-get-model.py
...
def get_network_mode(json_path):
    """
...
if __name__ == "__main__":
    ...
    result = get_network_mode(json_file)
    print(result)
